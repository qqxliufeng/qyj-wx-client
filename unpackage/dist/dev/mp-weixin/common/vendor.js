...
var urlPath = _interopRequireWildcard(__webpack_require__(/*! ./url-path.js */ 16));
var _userInfo = _interopRequireDefault(__webpack_require__(/*! ../data/user-info.js */ 17));
...
_vue.default.prototype.$paramsToString = _router.formateObjToParamStr;
_vue.default.prototype.$events = {
...
for (var filter in _filter.default) {
  _vue.default.filter(filter, _filter.default[filter]);
}

_vue.default.prototype.$http = function (options) {
  ...
  if (_userInfo.default.isLogin()) {
    options.params.token = _userInfo.default.getToken();
  }
  uni.request({
    header: {
...
_vue.default.prototype.$upload = function (options) {
  uni.showLoading({
    title: '正在上传…' });

  options.files.forEach(function (file, index) {
    uni.uploadFile({
      url: urlPath.imageActionUrl + '?token=' + _userInfo.default.getToken(),
      filePath: file,
      name: 'file',
      formData: {},
      success: function success(res) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.myYearCardInfo = exports.addCardImage = exports.addCardDetails = exports.myYearCard = exports.getOpenId = exports.wxLogin = exports.userInfo = exports.userInfoResetInfo = exports.userInfoResetPWUrl = exports.userInfoForgetPWUrl = exports.userInfoModileLoginUrl = exports.userInfoGetSMSCodeUrl = exports.userInfoRegisterUrl = exports.userInfoLoginUrl = exports.getGoodsInfo = exports.changeGoodsStatus = exports.getMyGoodsList = exports.addGoods = exports.getGoodsTypeList = exports.addFeedBack = exports.changeRentingState = exports.getRentingHouseInfo = exports.getRentingHouseByUId = exports.publishRentingHouseInfo = exports.addPhoneInfo = exports.getCommunityPhones = exports.communityInfo = exports.unBindCommunity = exports.setPrimaryCommunity = exports.bindCommunity = exports.getCommunities = exports.imageActionUrl = exports.imageUrl = exports.addHelpContent = exports.editLost = exports.closeLost = exports.publishLost = exports.getLostHelps = exports.getLostInfo = exports.getUserHelpList = exports.getUserLostList = exports.getMyAnswerList = exports.addAnswer = exports.editQuestionMessage = exports.closeQuestion = exports.getQuestionAnswerList = exports.getQuestionMessageInfo = exports.getQuestionListByUid = exports.publishQuestionMessage = exports.indexInfo = exports.baseUrl = void 0;
...
/* ================首页模块================ */exports.baseUrl = baseUrl;

var indexModule = 'index/';

var indexInfo = indexModule + 'index';

/* ================首页模块================ */

/* ================问答模块================ */exports.indexInfo = indexInfo;

var questionModule = 'questionMessage/';

var publishQuestionMessage = questionModule + 'publishQuestionMessage';exports.publishQuestionMessage = publishQuestionMessage;

var getQuestionListByUid = questionModule + 'getQuestionListByUid';exports.getQuestionListByUid = getQuestionListByUid;

var getQuestionMessageInfo = questionModule + 'getQuestionMessageInfo';exports.getQuestionMessageInfo = getQuestionMessageInfo;

var getQuestionAnswerList = questionModule + 'getQuestionAnswerList';exports.getQuestionAnswerList = getQuestionAnswerList;

var closeQuestion = questionModule + 'closeQuestion';exports.closeQuestion = closeQuestion;

var editQuestionMessage = questionModule + 'editQuestionMessage';exports.editQuestionMessage = editQuestionMessage;

var addAnswer = questionModule + 'addAnswer';exports.addAnswer = addAnswer;

var getMyAnswerList = questionModule + 'getMyAnswerList';

/* ================问答模块================ */

/* ================寻物模块================ */exports.getMyAnswerList = getMyAnswerList;

var lostModule = 'lost/';

var getUserLostList = lostModule + 'getLostListByUid';exports.getUserLostList = getUserLostList;

var getUserHelpList = lostModule + 'getHelpLostListByUid';exports.getUserHelpList = getUserHelpList;

var getLostInfo = lostModule + 'getLostInfo';exports.getLostInfo = getLostInfo;

var getLostHelps = lostModule + 'getHelpLostByLid';exports.getLostHelps = getLostHelps;

var publishLost = lostModule + 'publishLostInfo';exports.publishLost = publishLost;

var closeLost = lostModule + 'closeLost';exports.closeLost = closeLost;

var editLost = lostModule + 'editLost';exports.editLost = editLost;

var addHelpContent = lostModule + 'addHelpContent';

/* ================寻物模块================ */

/* ================公共模块================ */exports.addHelpContent = addHelpContent;

var imageUrl = baseIP;exports.imageUrl = imageUrl;

var commonModuleUrl = 'common/';

var imageActionUrl = baseIP + '/api/common/' + commonModuleUrl + 'upload';exports.imageActionUrl = imageActionUrl;

var communityModule = 'community/';

var getCommunities = communityModule + 'getAllCommunitiesByArea';exports.getCommunities = getCommunities;

var bindCommunity = communityModule + 'bindCommunity';exports.bindCommunity = bindCommunity;

var setPrimaryCommunity = communityModule + 'setPrimary';exports.setPrimaryCommunity = setPrimaryCommunity;

var unBindCommunity = communityModule + 'unBindCommunity';exports.unBindCommunity = unBindCommunity;

var communityInfo = communityModule + 'getCommunityInfo';exports.communityInfo = communityInfo;

var getCommunityPhones = communityModule + 'getPhoneInfos';exports.getCommunityPhones = getCommunityPhones;

var addPhoneInfo = communityModule + 'addPhoneInfo';

/* ================公共模块================ */

/* ================租房模块================ */exports.addPhoneInfo = addPhoneInfo;

var rentingHouseModule = 'rentinghouse/';

var publishRentingHouseInfo = rentingHouseModule + 'publishRentingHouseInfo';exports.publishRentingHouseInfo = publishRentingHouseInfo;

var getRentingHouseByUId = rentingHouseModule + 'getRentingHouseByUId';exports.getRentingHouseByUId = getRentingHouseByUId;

var getRentingHouseInfo = rentingHouseModule + 'rentingHouseInfo';exports.getRentingHouseInfo = getRentingHouseInfo;

var changeRentingState = rentingHouseModule + 'changeRentingState';

/* ================租房模块================ */

/* ================意见反馈模块================ */exports.changeRentingState = changeRentingState;
var feedBackModule = 'feedback/';

var addFeedBack = feedBackModule + 'addFeedBack';

/* ================意见反馈模块================ */

/* ================商品模块================ */exports.addFeedBack = addFeedBack;

var goodsModule = 'goods/';

var getGoodsTypeList = goodsModule + 'getGoodsTypeList';exports.getGoodsTypeList = getGoodsTypeList;

var addGoods = goodsModule + 'addGoods';exports.addGoods = addGoods;

var getMyGoodsList = goodsModule + 'getMyGoodsList';exports.getMyGoodsList = getMyGoodsList;

var changeGoodsStatus = goodsModule + 'changeStatus';exports.changeGoodsStatus = changeGoodsStatus;

var getGoodsInfo = goodsModule + 'getGoodsInfo';

/* ================商品模块================ */exports.getGoodsInfo = getGoodsInfo;
...
var myYearCard = userInfoUrl + 'yearCard';exports.myYearCard = myYearCard;

var addCardDetails = userInfoUrl + 'addCardDetails';exports.addCardDetails = addCardDetails;

var addCardImage = userInfoUrl + 'addCardImage';exports.addCardImage = addCardImage;

var myYearCardInfo = userInfoUrl + 'cardDetails';exports.myYearCardInfo = myYearCardInfo;
...
{
  state: userInfo,
  saveUserInfo: function saveUserInfo(data, communities) {
  ...
  saveUserAvatar: function saveUserAvatar(avatar) {
    this.state.avatar = avatar;
    uni.setStorageSync('userInfo', this.state);
  },
  saveUserNickName: function saveUserNickName(nickName) {
  ...
  isBindCommunity: function isBindCommunity() {
    var communities = uni.getStorageSync('communities');
    return communities && communities.length > 0;
  },
  saveCommunities: function saveCommunities(communities) {
    uni.setStorageSync('communities', communities);
  },
  getCommunities: function getCommunities() {
    return uni.getStorageSync('communities');
  },
  getPrimaryCommunity: function getPrimaryCommunity() {
    return uni.getStorageSync('communities').filter(function (item) {
      return Number(item.pivot.is_primary) === 1;
    })[0];
  },
  getCommunitiesCount: function getCommunitiesCount() {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _urlPath = __webpack_require__(/*! ../utils/url-path.js */ 16);
var hoursDiff = 1 * 60 * 60 * 1000;
var daysDiff = 24 * hoursDiff;
var mounthsDiff = 30 * daysDiff;
var yearsDiff = 12 * mounthsDiff;var _default =
{
  timeFilter: function timeFilter(time) {
    var dataTime = new Date(time * 1000);
    var now = new Date();
    var diff = now - dataTime;
    if (diff < hoursDiff) {
      return '刚刚';
    }
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.bMapTransqqMap = bMapTransqqMap;exports.default = void 0;var weekMap = {
  '1': '一',
  '2': '二',
  '3': '三',
  '4': '四',
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  onLoad: function onLoad() {var _this = this;
    uni.$on('onLogin', function () {
      _this.isLogin = true;
      if (_this.onLogin) _this.onLogin();
    });
  } };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
